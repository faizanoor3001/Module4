...
def restaurantsJSON():
	...
	return jsonify(Restaurant = [restaurant.serialize for restaurant in restaurantList])
...
def restaurants():
	...
	return render_template('RestaurantAll_template.html', restaurants = restaurants)

@app.route('/restaurants/new', methods=['GET','POST'])
def newRestaurant():
	if request.method == 'POST':
		newRestaurantData = Restaurant(name = request.form['restaurantName'])
		session.add(newRestaurantData)
		session.commit()
		flash("New Restaurant Created")
		return redirect(url_for('restaurants'))
	else:
		return render_template('newRestaurant_template.html')
...
def editRestaurant(restaurant_id):
	...
	if request.method == 'POST':
		...
		return render_template('editRestaurant_template.html', restaurant = restaurant)
...
def deleteRestaurant(restaurant_id):
	...
	if request.method == 'POST':
		...
		session.commit()
		flash("Deleted the restaurant successfully")
		return redirect(url_for('restaurants'))
	else:
		return render_template('deleteRestaurant_template.html', restaurant = restaurant)
